...
export default function Login() {
    ...
    const { user, loading, error, success, authChecked } = useSelector(state => state.auth);
    ...
    const handleSubmit = (e) => {
        ...
        if (isRegister) {
            if (
                ...
                newErrors.allInput = 'Пожалуйста, заполните все поля!';
            }
            ...
            if (!formValues.surname) {
                newErrors.surname = 'Введите вашу фамилию';
            }
            ...
            if (!usernameRegex.test(formValues.username)) {
                newErrors.username = 'Имя пользователя может содержать только английские буквы и цифры';
            }
            ...
            <div className={style.authPageRight}>
                <div className={style.authFormContainer}>
                    ...
                    <form className={style.authForm} onSubmit={handleSubmit}>
                            ...
                            <div key={index} className={style.authFormGroup}>
                                ...
                                <div className={style.authFormInputWrapper}>
                                    <input
                                        ...
                                        className={cn(
                                            style.authFormInput,
                                            errors[input.for] && style.authFormInputError
                                        )}
                                    />
                                    ...
                                    {errors[input.for] && <div className={style.authErrors}>{errors[input.for]}</div>}
                                </div>
                            </div>
                        ))}
                        {!isRegister ? (
                        ...
                        <button type="submit" className={style.authSubmitButton} disabled={loading}>
                            {loading ? (
