        ...
        <div className={cn(style.postCard, style.glass)}>
            <div className={style.postHeader}>
                <div className={style.postAuthor}>
                    <img src={authUser?.avatar ?? '/user.png'} alt="Анна Смирнова" className={style.postAvatar}></img>
                    <div className={style.postAuthorInfo}>
                        <div className={style.postAuthorName}>{authUser?.name} {authUser?.surname}</div>
                        <div className={style.postAuthorDate}>@{authUser?.username} • 2 часа назад</div>
                    </div>
                </div>
                <button className={cn(style.postMenuButton, style.glassButton, style.more)}>
